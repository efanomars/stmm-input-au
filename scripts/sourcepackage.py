...
# Creates a source package containing all stmm-input-au related projects.

g_sProjectName = "stmm-input-au"

g_aProjDirs = ["libstmm-input-au"
				, "libstmm-input-openal/examples/wander"
