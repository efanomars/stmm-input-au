...
# File:   uninstall_stmm-input-au-all.py

# Removes all files installed by the install_stmm-input-au-all.py script.
...
def main():
	import argparse
	oParser = argparse.ArgumentParser("Removes all files created by install_stmm-input-au-all.py")
	...
	subprocess.check_call("./libstmm-input-au/scripts/uninstall_libstmm-input-au.py -y {} {}"
						" --installdir {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())
	subprocess.check_call("./libstmm-input-openal/scripts/uninstall_libstmm-input-openal.py -y {} {}"
						" --installdir {}  {}"\
						.format(sNoClean, sNoUninstall, sInstallDir, sSudo).split())
