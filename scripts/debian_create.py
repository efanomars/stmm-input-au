...
g_sSourceProjectName = "stmm-input-au"

# The subprojects
g_oSubPrjs = ["libstmm-input-au", "libstmm-input-openal"]
# The binaries containing shared object libraries for runtime
g_oBinLibs = ["libstmm-input-au", "libstmm-input-openal"]
# The binaries containing headers, documents and shared object libraries for building
g_oDevLibs = ["libstmm-input-au-dev", "libstmm-input-openal-dev"]
